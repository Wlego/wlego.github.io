...
;(function ( $, window, document, undefined ) {
  ...
  var clndrTemplate = "<div class='clndr-controls'>" +
    "<div class='clndr-control-button'><p class='clndr-previous-button'><span class='glyphicon glyphicon-chevron-left' aria-hidden='true'></span></p></div><div class='month'><%= month %> <%= year %></div><div class='clndr-control-button'><p class='clndr-next-button'><span class='glyphicon glyphicon-chevron-right' aria-hidden='true'></span></p></div>" +
    "</div>" +
